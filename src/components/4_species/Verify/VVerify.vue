<template>
  <Heading margin="0 0 8px">Check your email</Heading>
  <Text>
    You should receive a verification code from us at:
    <Text as="span" size="textLgSemibold">{{ createAccStore.email }}</Text
    >.
  </Text>
  ...
  <BannerAlert margin="8px 0 0">
    ...
    <Text size="textSmRegular" margin="0 0 12px"
      >Check your spam folder or promo tabs.</Text
    >
    <Link
      page="CreateAccount"
      size="textSmSemibold"
